 ...
 * @author HECTOR
 */
public class RegistroSecretaria extends javax.swing.JPanel {
    ...
    public void paintComponent(Graphics g)
    {
        ...
        ImageIcon Imagen=new ImageIcon(new ImageIcon(getClass().getResource("/Imagenes/Secretaria.jpg")).getImage());
